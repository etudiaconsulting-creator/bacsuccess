    ...
    '{
      "flashcards": [
        ...
        },
        {
          ...
          "answer": "1. Essai argumentatif (for/against): defendre une position avec des arguments pour et contre. On donne clairement son opinion. 2. Essai discursif (balanced view): présenter les deux cotes d''un débat de manière équilibrée. 3. Essai descriptif: decrire un lieu, une personne, un événement avec des details sensoriels. 4. Essai narratif: raconter une histoire ou une experience personnelle avec une leçon ou morale à la fin."
        },
        {
          "id": "fc5",
          "category": "Formule",
      ...
      "quiz": [
        ...
        {
          "id": "q4",
          "question": "Quel type d''essai présenté les deux cotes d''un débat de manière équilibrée ?",
          "options": ["Essai argumentatif", "Essai discursif", "Essai narratif", "Essai descriptif"],
          "correct": 1,
          "explanation": "L''essai discursif (balanced view) présenté les arguments pour et contre de manière équilibrée, sans nécessairement prendre position. L''essai argumentatif, en revanche, defend clairement une position."
        },
        {
          "id": "q5",
    ...
    '{
      ...
      "quiz": [
        ...
        },
        {
          ...
          "correct": 1,
          "explanation": "Salary désigne un salaire fixe verse mensuellement ou annuellement, généralement pour les employes de bureau. Wages désigne un salaire calculé à l''heure ou à la journée, souvent pour les travailleurs manuels ou a temps partiel."
        },
        {
          "id": "q5",
