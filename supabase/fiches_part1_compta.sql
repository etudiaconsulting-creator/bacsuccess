...
BEGIN
  ...
  VALUES (
    ...
    '{
      ...
      "quiz": [
        {"id": "q1", "question": "Qui est le tireur d''une lettre de change ?", "options": ["Le débiteur qui doit payer", "Le créancier qui crée la lettre", "La banque qui escompte", "Le bénéficiaire final"], "correct": 1, "explanation": "Le tireur est le créancier. Il tire (créé) la lettre de change et donne l''ordre au tire (débiteur) de payer."},
  ...
  VALUES (
    ...
    '{
      "flashcards": [
        ...
        {"id": "fc5", "question": "Comment fonctionne la TVA deductible sur immobilisations ?", "answer": "Compte 4451 - TVA recuperable sur immobilisations. Debit au moment de l''acquisition. Elle vient en déduction de la TVA collectée lors de la declaration de TVA.", "category": "Méthode"},
